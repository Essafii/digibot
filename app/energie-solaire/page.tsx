        ...
        <section className="px-6 py-20">
          <div className="mx-auto max-w-6xl text-center">
            ...
            <div className="mt-14 grid gap-8 md:grid-cols-5">
              {[
                ["✅", "Étude personnalisée", "Analyse de votre consommation pour bien dimensionner l’installation."],
                ["🔧", "Installation sécurisée", "Équipes qualifiées et installation conforme."],
                ["📈", "Matériel fiable", "Panneaux, batteries et onduleurs de marques reconnues."],
